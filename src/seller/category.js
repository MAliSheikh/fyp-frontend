export const categories = [
    ...
    { name: "Sports", subcategories: ["Cricket", "Football", "Badminton", "Fitness", "Outdoor Gear"] },
    { name: "Toys", subcategories: ["Action Figures", "Dolls", "Educational Toys", "Puzzles", "Board Games"] },
    { name: "Groceries", subcategories: ["Fruits", "Vegetables", "Dairy", "Snacks", "Beverages"] },
    { name: "Furniture", subcategories: ["Living Room", "Bedroom", "Kitchen", "Outdoor", "Office"] },
    { name: "Automobiles", subcategories: ["Cars", "Bikes", "Accessories", "Tools", "Spare Parts"] },
  ];
